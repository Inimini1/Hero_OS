...
HeroOS.views.jarvis = {
  ...
  render(root) {
    ...
    root.innerHTML = `
      ...
      ${
        !configured
          ? `<div class="panel notice-panel">No AI provider configured. Running in local command mode — try "today", "primary", "suit check", "captures today", "calendar", "inbox", or "add mission: &lt;title&gt;". Connect a real AI provider anytime in <a href="#/settings">Settings</a>.</div>`
          : ''
      }
